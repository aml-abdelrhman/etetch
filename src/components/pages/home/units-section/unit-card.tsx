    ...
    <Card className="relative overflow-hidden">
      ...
      <CardFooter className="flex flex-col gap-2 items-center justify-center">
        <div className="flex items-center gap-5 w-full">
          <FutureItemCard Icon={BedIcon} value={String(unit.rooms)} />
          <FutureItemCard Icon={VectorSquareIcon} value={unit.area} />
          <FutureItemCard Icon={StarisUpIcon} value={unit.floor} />
        </div>
        {!isReserved && (
